...
-   Explorations in Visualizations (across policy and time)

-   Regression on Turnout (presidential vs midterm elections) vs Policy


## Box plot - turnout percentage by stance
<center>
![turnout box plot](images/boxplot.png){width=60%}
</center>

## Regression Results

<center>
![Regression results](images/regression results of midterm and presidential turnouts.png){width=70%}
</center>
