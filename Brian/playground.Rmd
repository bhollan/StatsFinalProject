...
combined_2020 <- read_excel("../source_data/VoteAndRegByState2020.xlsx", range = "A7:E58")
names(combined_2020) <- c("Sate", "population", "citizens", "registered", "registered_percent")

prez_wide_A <- read_excel("../source_data/VoteAndRegByStateHistory_prezA.xlsx")
prez_wide_B <- read_excel("../source_data/VoteAndRegByStateHistory_prezB.xlsx")
