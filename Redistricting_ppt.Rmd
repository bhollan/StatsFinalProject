...
![US stance as of 2012](images/redist_map_2012.png){width=50%}
...
![turnout box plot](images/boxplot.png){width=50%}
...
-   Regression
![Regression results](images/regression results of midterm and presidential turnouts.png)

## Margin

![Party votes per party votes](images/points_votes.png){width=110%}